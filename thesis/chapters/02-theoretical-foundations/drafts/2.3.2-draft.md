...
**SIR-4 (self-citation transparency)** — ✅ Satisfied. *"In previously published results … "* + extension statement (V5 two-stage protocol, §3.3.3) (¶3–4).
...
**Hypotheses (H-x)** — ⚪ None advanced; notes H-3 dropped (¶4).
