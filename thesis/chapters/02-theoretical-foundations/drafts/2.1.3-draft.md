...
**CFC-2.2 (no superiority claim)** — ✅ Satisfied. No filter is ranked above another, and the V5 non-adoption is explicitly *not* a superiority claim: *"This is a design rationale, not a claim of superiority over a denoising-augmented pipeline"* (¶5). No named-method superiority present.
...
**V5 non-adoption honesty** — ✅ Satisfied. *"The V5 pipeline does not adopt bilateral filtering or non-local means as an explicit stage"* (¶5); noise handled via Stage 5 clip limit and Stage 4 flat-field, attributed to OD-3. No implication of a dedicated denoiser.
