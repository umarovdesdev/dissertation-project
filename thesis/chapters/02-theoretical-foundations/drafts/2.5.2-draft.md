...
> Draft generated per `prompts/writing-session-system-prompt.md` v6.0.0 · Brief: `briefs/2.5.2-brief.md` · Binding reference: INVARIANTS.md v6.0.0 · Sources: #57 (`zhou-2016-cam.md`), #58 (`chattopadhyay-2018-grad-cam-plus-plus.md`), #46 (Selvaraju et al., 2017 — index-only, no card). No equations; no figures.
...
**SIR-2 (limitation inheritance at first citation)** — ✅ Satisfied. #57 "weakly supervised localization … remains substantially less accurate than fully supervised localization even on natural images" (¶4); #58 method-dependence + (carried) small cohort (¶3); #46 missing-card note (¶4).
...
**#46 missing-card flag** — ✅ Handled. *"The Grad-CAM method itself is cited here from the dissertation's literature index, its structured card pending"* (¶4).
...
None. (#46 Selvaraju Grad-CAM card absent/index-only — flagged for corpus completion.)
