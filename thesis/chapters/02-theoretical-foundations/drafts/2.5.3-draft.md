...
**CFC-2.2 (no superiority claim)** — ✅ Satisfied. *"the condition ALO_preproc > ALO_baseline posed by H-5 — is an empirical question reserved for Experiment 4 (§4.5) … no such result is asserted here"* (¶6).
...
**EH-3 / EH-4** — ⚪ Not applicable. Non-experimental; H-5 evaluation in §4.5.

**Hypotheses (H-x)** — ⚪ None advanced; defines H-5 metrics, condition deferred to §4.5.
