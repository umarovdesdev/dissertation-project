...
**DGL-5 (CLAHE parameter portability)** — ✅ Satisfied. *"Consistent with the parameter-portability constraint (DGL-5), the clip factor and global threshold used in the V5 pipeline are determined by the parameter sweep of Experiment 2"* (hyperparameter ¶).
