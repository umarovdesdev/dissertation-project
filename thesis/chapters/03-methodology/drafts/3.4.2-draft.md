...
> Draft generated per `prompts/writing-session-system-prompt.md` v6.0.0 · Brief: `briefs/3.4.2-brief.md` · Binding reference: INVARIANTS.md v6.0.0 · Sources: #21 (`yesmukhamedov-kbtu.md`, 🔹SELF). TAB-3.1 rendered inline from governance (RESEARCH_ARCHITECTURE §4.0); FIG-3.13 referenced by placeholder, not embedded.
...
**SIR-1 / SIR-4 (self-citation)** — ✅ Satisfied. #21 prior own-work protocol precedent (implicit in §6.8 usage); no amplification.
...
PART 1 body: ~1,000 words by manual count incl. TAB-3.1 prose (within the 900–1,100 target; mid-band).
