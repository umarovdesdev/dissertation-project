...
**Hypotheses (H-x)** — ⚪ Previewed, not advanced/validated. H-1, H-2, H-4, H-5, H-6, H-7 named as the planned tests (¶4); H-3 correctly omitted (dropped in V3). No hypothesis asserted as confirmed.
