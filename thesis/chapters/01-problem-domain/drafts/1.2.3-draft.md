...
> Draft generated per `prompts/writing-session-system-prompt.md` v6.0.0 · Brief: `briefs/1.2.3-brief.md` · Binding reference: INVARIANTS.md v6.0.0 · Sources: #47/#49/#50/#51 (dataset descriptors — index-level, no card files), #74 (`zhou-2022-domain-generalization-survey.md`), #75 (`wang-2018-deep-visual-domain-adaptation-survey.md`). Figures: FIG-1.2.
...
**Coverage-gap discipline (no cards for #47/#49/#50/#51; #51 "TO BE IDENTIFIED")** — ✅ Satisfied. Camera facts cited as "documented acquisition properties of the public datasets" (¶3); no cross-device performance magnitude asserted (*"no cross-device performance magnitude is claimed here"*, ¶6). [Note: ODIR-5K descriptor is index-flagged "TO BE IDENTIFIED"; cited only at the camera-attribute level consistent with that status.]

**Hypotheses (H-x) / EH-3 / EH-4** — ⚪ Not applicable. Motivating section; H-6 tested later (§4.7), no dominance/validation claim here.
