...
> Draft generated per `prompts/writing-session-system-prompt.md` v6.0.0 · Brief: `briefs/1.3.2-brief.md` · Binding reference: INVARIANTS.md v6.0.0 · Sources: #12 (`gulshan-2016.md`), #02 (`saxena-2020.md`), #09 (`xu-2024-hybrid.md`), #73 (`cheplygina-2018-not-so-supervised-survey.md`). Figures: none.
...
**SIR-1 (non-amplification; THIN/GAP flag)** — ✅ Satisfied. Verbatim: *"the retinal-specific self-supervised literature is not represented by primary sources in this dissertation's corpus … the general survey above does not supply retinal-specific empirical results. The in-domain self-supervised pretraining used in this dissertation is therefore presented as the candidate's own methodological design … rather than as a result imported from the literature"* (¶6). #73 not over-attributed.
