...
**Data Augmentation** — оқыту деректерінің вариабельділігін арттыру және жалпылауды жақсарту үшін қолданылатын кескін түрлендірулері (аударып шығару, бұру, масштабтау, жарықтық/контраст, PCA түс); конвейердің тек оқытуға арналған 6-кезеңі.
